...
The Creator Console uses the same public Supabase client boundary but relies on creator-only RPCs and capabilities for people management. See [`creator_app/README.md`](creator_app/README.md), [`supabase/migrations/20260825_0005_creator_authorization.sql`](supabase/migrations/20260825_0005_creator_authorization.sql), [`supabase/migrations/20260825_0006_creator_control_rpc.sql`](supabase/migrations/20260825_0006_creator_control_rpc.sql), and [`docs/PRODUCTION_COMPLETION_AND_CREATOR_APP_PLAN.md`](docs/PRODUCTION_COMPLETION_AND_CREATOR_APP_PLAN.md). For cloning, Supabase setup, Flutter Web/native runs, test commands, and the guarded isolated E2E suites, use [`docs/CLONE_AND_LOCAL_RUN_GUIDE.md`](docs/CLONE_AND_LOCAL_RUN_GUIDE.md). For the current one-command setup, debug, analyze, test, and cross-platform build workflow, use [`docs/LOCAL_BUILD_DEBUG_GUIDE.md`](docs/LOCAL_BUILD_DEBUG_GUIDE.md) and `tools/flutter_yemen.sh` or `tools/flutter_yemen.ps1`. The complete 32-feature ERP expansion map and staged implementation status are documented in [`docs/ERP_EVOLUTION_BLUEPRINT.md`](docs/ERP_EVOLUTION_BLUEPRINT.md).
