...
assert_anon_denied ai_propose_action_tool_call '{"p_run_id":"00000000-0000-0000-0000-000000000000","p_sequence_no":1,"p_tool_name":"merchant.inventory_adjustment","p_action_class":"reversible_write","p_arguments_hash":"anonymous-arguments-hash-123456","p_arguments_redacted":{},"p_arguments_payload":{},"p_required_capability":null,"p_approval_required":true,"p_policy_decision":"needs_approval","p_idempotency_key":"anonymous-ai-action-tool"}'
...
assert_anon_denied ai_list_action_definitions '{}'
assert_anon_denied ai_get_platform_settings '{}'
assert_anon_denied ai_get_action_definition '{"p_action_key":"merchant.inventory_adjustment"}'
assert_anon_denied ai_get_action_payload '{"p_tool_call_id":"00000000-0000-0000-0000-000000000000"}'
assert_anon_denied ai_set_action_enabled '{"p_action_key":"merchant.catalog_bulk_save","p_enabled":false,"p_reason":"anonymous"}'
assert_anon_denied ai_publish_platform_settings '{"p_model":null,"p_provider_enabled":false,"p_background_enabled":false,"p_knowledge_enabled":false,"p_external_agent_enabled":false,"p_max_tool_calls":8,"p_max_workflow_attempts":3,"p_reason":"anonymous"}'
assert_anon_denied ai_upsert_knowledge_source '{"p_scope_type":"global","p_scope_id":null,"p_source_key":"anonymous","p_title":"Anonymous","p_source_kind":"faq","p_source_uri":null,"p_source_version":1,"p_status":"draft","p_trust_class":"internal","p_content_hash":"anonymous-content-hash-1234","p_metadata":{},"p_reason":"anonymous"}'
assert_anon_denied ai_add_knowledge_chunk '{"p_source_id":"00000000-0000-0000-0000-000000000000","p_ordinal":0,"p_content":"anonymous","p_content_hash":"anonymous-chunk-hash-1234","p_reason":"anonymous"}'
assert_anon_denied ai_search_knowledge '{"p_scope_type":"global","p_scope_id":null,"p_query":"anonymous","p_limit":1}'
assert_anon_denied ai_enqueue_workflow '{"p_app_surface":"merchant","p_scope_type":"shop","p_scope_id":"00000000-0000-0000-0000-000000000000","p_workflow_key":"merchant.alert_summary","p_input_hash":"anonymous-workflow-hash-1234","p_payload_redacted":{},"p_idempotency_key":"anonymous-workflow","p_max_attempts":1}'
assert_anon_denied ai_register_external_client '{"p_client_id":"anonymous-client","p_name":"Anonymous","p_redirect_uri":"https://example.invalid/callback","p_reason":"anonymous"}'
assert_anon_denied ai_revoke_external_client '{"p_client_id":"anonymous-client","p_reason":"anonymous"}'
assert_anon_denied ai_grant_external_consent '{"p_client_id":"anonymous-client","p_redirect_uri":"https://example.invalid/callback","p_scope":"ai.read"}'
assert_anon_denied ai_revoke_external_consent '{"p_consent_id":"00000000-0000-0000-0000-000000000000"}'
assert_anon_denied ai_check_external_consent '{"p_client_id":"anonymous-client","p_redirect_uri":"https://example.invalid/callback"}'
assert_anon_denied ai_list_my_workflows '{}'
assert_anon_denied ai_external_agent_gate '{}'
assert_anon_denied ai_consume_external_quota '{"p_client_id":"anonymous-client","p_redirect_uri":"https://example.invalid/callback"}'
assert_anon_denied ai_background_gate '{}'
assert_anon_denied erp_list_feature_catalog '{}'
assert_anon_denied erp_get_my_organization_dashboard '{}'
assert_anon_denied erp_list_feature_registry '{}'
assert_anon_denied erp_get_org_dashboard '{"p_organization_id":"00000000-0000-0000-0000-000000000000"}'
assert_anon_denied erp_create_organization '{"p_market_id":"00000000-0000-0000-0000-000000000000","p_code":"ANON","p_name_ar":"مؤسسة مجهولة","p_reason":"anonymous","p_legal_name":null,"p_merchant_id":null}'
assert_anon_denied erp_create_legal_entity '{"p_organization_id":"00000000-0000-0000-0000-000000000000","p_code":"ANON","p_name_ar":"كيان مجهول","p_reason":"anonymous","p_registration_reference":null,"p_tax_reference":null}'
assert_anon_denied erp_create_book '{"p_legal_entity_id":"00000000-0000-0000-0000-000000000000","p_code":"LOCAL","p_name_ar":"دفتر محلي","p_accounting_basis":"local_tax","p_reason":"anonymous","p_currency":"YER"}'
assert_anon_denied erp_create_account '{"p_book_id":"00000000-0000-0000-0000-000000000000","p_parent_account_id":null,"p_code":"1000","p_name_ar":"نقدية","p_account_type":"asset","p_normal_balance":"debit","p_reason":"anonymous"}'
...
assert_anon_denied merchant_get_operations_summary '{}'
assert_anon_denied merchant_upsert_channel '{"p_shop_id":"00000000-0000-0000-0000-000000000000","p_channel_key":"anonymous","p_display_name":"قناة مجهولة","p_channel_kind":"web","p_status":"draft","p_reason":"anonymous"}'
assert_anon_denied merchant_upsert_channel_listing '{"p_channel_id":"00000000-0000-0000-0000-000000000000","p_product_id":"00000000-0000-0000-0000-000000000000","p_listing_status":"draft","p_channel_title":"منتج مجهول","p_channel_description":null,"p_price_override_minor":null,"p_currency_override":null,"p_reason":"anonymous"}'
assert_anon_denied merchant_create_shipment_plan '{"p_merchant_order_id":"00000000-0000-0000-0000-000000000000","p_carrier_key":"merchant_arranged","p_service_level":null,"p_reason":"anonymous"}'
assert_anon_denied merchant_record_shipment_event '{"p_shipment_plan_id":"00000000-0000-0000-0000-000000000000","p_status":"ready","p_customer_message":null,"p_reason":"anonymous"}'
assert_anon_denied merchant_open_delivery_exception '{"p_shipment_plan_id":"00000000-0000-0000-0000-000000000000","p_code":"address_issue","p_severity":"medium","p_customer_message":"رسالة","p_reason":"anonymous"}'
assert_anon_denied merchant_resolve_delivery_exception '{"p_exception_id":"00000000-0000-0000-0000-000000000000","p_status":"resolved","p_reason":"anonymous"}'
assert_anon_denied merchant_start_return_logistics '{"p_order_case_id":"00000000-0000-0000-0000-000000000000","p_method":"seller_arranged","p_customer_message":null,"p_reason":"anonymous"}'
assert_anon_denied merchant_record_return_event '{"p_return_logistics_id":"00000000-0000-0000-0000-000000000000","p_status":"label_pending","p_customer_message":null,"p_reason":"anonymous"}'
assert_anon_denied merchant_upsert_channel '{"p_shop_id":"00000000-0000-0000-0000-000000000000","p_channel_key":"anonymous","p_display_name":"قناة مجهولة","p_channel_kind":"web","p_status":"draft","p_reason":"anonymous","p_idempotency_key":"anonymous-channel-key"}'
assert_anon_denied merchant_upsert_channel_listing '{"p_channel_id":"00000000-0000-0000-0000-000000000000","p_product_id":"00000000-0000-0000-0000-000000000000","p_listing_status":"draft","p_channel_title":"منتج مجهول","p_channel_description":null,"p_price_override_minor":null,"p_currency_override":null,"p_reason":"anonymous","p_idempotency_key":"anonymous-listing-key"}'
assert_anon_denied merchant_create_shipment_plan '{"p_merchant_order_id":"00000000-0000-0000-0000-000000000000","p_carrier_key":"merchant_arranged","p_service_level":null,"p_reason":"anonymous","p_idempotency_key":"anonymous-shipment-key"}'
assert_anon_denied merchant_record_shipment_event '{"p_shipment_plan_id":"00000000-0000-0000-0000-000000000000","p_status":"ready","p_customer_message":null,"p_reason":"anonymous","p_idempotency_key":"anonymous-shipment-event-key"}'
assert_anon_denied merchant_open_delivery_exception '{"p_shipment_plan_id":"00000000-0000-0000-0000-000000000000","p_code":"address_issue","p_severity":"medium","p_customer_message":"رسالة","p_reason":"anonymous","p_idempotency_key":"anonymous-exception-key"}'
assert_anon_denied merchant_resolve_delivery_exception '{"p_exception_id":"00000000-0000-0000-0000-000000000000","p_status":"resolved","p_reason":"anonymous","p_idempotency_key":"anonymous-resolve-key"}'
assert_anon_denied merchant_start_return_logistics '{"p_order_case_id":"00000000-0000-0000-0000-000000000000","p_method":"seller_arranged","p_customer_message":null,"p_reason":"anonymous","p_idempotency_key":"anonymous-return-key"}'
assert_anon_denied merchant_record_return_event '{"p_return_logistics_id":"00000000-0000-0000-0000-000000000000","p_status":"label_pending","p_customer_message":null,"p_reason":"anonymous","p_idempotency_key":"anonymous-return-event-key"}'
